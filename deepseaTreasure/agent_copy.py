...
from diverse_mem_attentive import DiverseMemoryWithAER
from history import *
from utils import *
...
class DeepAgent():
    ...
    def policy_update(self, current_state):
        ...
        # ids, batch, _ = self.buffer.sample_attentive(self.sample_size, self.k, current_state)
    ...
    def initialize_memory(self):
        ...
        self.buffer = DiverseMemoryWithAER(
    ...
    def memorize(self,
        ...
        idx = self.buffer.add(
            transition, pred_idx=pred_idx, trace_id=trace_id)
...
if __name__ == "__main__":
    ...
    extra = "NER_1-lstm-{} clipN-{} clipV-{} attention-{} a-{} m-{} s-{}  e-{} d-{} x-{} {} p-{} fs-{} d-{} up-{} lr-{} e-{} p-{} m-{}-{}".format(
