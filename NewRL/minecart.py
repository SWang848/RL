...
class Minecart:
    ...
    def convex_coverage_set(self, frame_skip=4, discount=0.98, incremental_frame_skip=True, symmetric=True):
        """
    ...
    def pareto_coverage_set(self, frame_skip=4, discount=0.98, incremental_frame_skip=True, symmetric=True):
        """
